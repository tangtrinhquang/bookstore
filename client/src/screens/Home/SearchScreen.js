...
const SearchScreen = ({ match }) => {
    ...
    useEffect(() => {
        dispatch(searchBooks(keyword, genres, priceTop, priceBottom, pageNumber));
    }, [dispatch, keyword, genres, priceTop, priceBottom, pageNumber]);
            ...
            {loading ? (
                ...
                <>
                    ...
                    <Paginate
                        ...
                        pages={pages}
                        page={page}
                        query={`keyword=${keyword}&genres=${genres}&bottom=${priceBottom}&top=${priceTop}`}
                    />
                </>
            )}
        </Container>
